...
|---|---|---|---|---|---|
| 1 | `afp-speed` | --afp-speed <f> | cli-arg | - | n/a |
| 2 | `animation` | --animation <name> | cli-arg | - | n/a |
| 3 | `animation-label` | --animation-label <l> | cli-arg | - | n/a |
| 4 | `blend-frames` | --blend-frames <N> | cli-arg | - | n/a |
| 5 | `blend-loop` | --blend-loop | cli-arg | - | n/a |
| 6 | `boot-ifses` | --boot-ifses | cli-arg | - | n/a |
| 7 | `cmd-trace` | --cmd-trace <path> | cli-arg | - | n/a |
| 8 | `continuous-loop` | --continuous-loop <N> | cli-arg | - | n/a |
| 9 | `csv-empty-token-tolerance` *(audit)* | comma-list flags given empty tokens (--export-crop, --export-bg, --screenshot-frames, --submonitor-frames) | cli-arg | - | n/a |
| 10 | `deferred-replay` | --deferred-replay | cli-arg | - | n/a |
| 11 | `dump-anim-info` | --dump-anim-info <out.json> | cli-arg | - | n/a |
| 12 | `duplicate-scalar-flag-last-wins` *(audit)* | any scalar flag repeated in one command line | cli-arg | - | n/a |
| 13 | `exit-after-frames` | --exit-after-frames <N> | cli-arg | - | n/a |
| 14 | `export` | --export <path> | cli-arg | - | n/a |
| 15 | `export-bg` | --export-bg <transparent\|none\|R,G,B> | cli-arg | - | n/a |
| 16 | `export-crop` | --export-crop <X,Y,W,H> | cli-arg | - | n/a |
| 17 | `export-dump-frames` | --export-dump-frames <dir> | cli-arg | - | n/a |
| 18 | `export-format` | --export-format <avif\|webm\|webm-av1\|webp\|png\|mp4> | cli-arg | - | n/a |
| 19 | `export-format-alias-tokens` *(audit)* | --export-format <webm-vp9\|vp9\|av1\|webp-anim\|png-seq\|pngseq\|h264\|avc\|mp4-h264> | cli-arg | - | n/a |
| 20 | `export-format-mp4-hevc-alpha` *(audit)* | --export-format <mp4-hevc-alpha\|hevc\|hevc-alpha\|mp4-hevc\|safari> | cli-arg | - | n/a |
| 21 | `export-fps` | --export-fps <N> | cli-arg | - | n/a |
| 22 | `export-keyframe-interval` | --export-keyframe-interval <N> | cli-arg | - | n/a |
| 23 | `export-loop-count` | --export-loop-count <N> | cli-arg | - | n/a |
| 24 | `export-max-frames` | --export-max-frames <N> | cli-arg | - | n/a |
| 25 | `export-no-hw` | --export-no-hw | cli-arg | - | n/a |
| 26 | `export-quality` | --export-quality <0-100> | cli-arg | - | n/a |
| 27 | `export-size` | --export-size <WxH> | cli-arg | - | n/a |
| 28 | `export-sw` | --export-sw | cli-arg | - | n/a |
| 29 | `extract-qpro` | --extract-qpro <dir> | cli-arg | - | n/a |
| 30 | `filter` | --filter | cli-arg | - | n/a |
| 31 | `fps` | --fps <N> | cli-arg | - | n/a |
| 32 | `game-dir` | --game-dir <path> | cli-arg | - | n/a |
| 33 | `goto-label` | --goto-label <l> | cli-arg | - | n/a |
| 34 | `headless` | --headless | cli-arg | - | n/a |
| 35 | `headless-without-game-dir-exits-1` *(audit)* | --headless with no --game-dir | cli-arg | - | n/a |
| 36 | `help-long` | --help | cli-arg | - | n/a |
| 37 | `help-short` | -h | cli-arg | - | n/a |
| 38 | `help-slash` | /? | cli-arg | - | n/a |
| 39 | `hide` | --hide <path> | cli-arg | - | n/a |
| 40 | `hide-sublayer` | --hide-sublayer <path> | cli-arg | - | n/a |
| 41 | `ifs` | --ifs <path> | cli-arg | - | n/a |
| 42 | `ifs2` | --ifs2 <path> | cli-arg | - | n/a |
| 43 | `int-opt-unvalidated-value` *(audit)* | the nine kIntOpts flags given a negative, junk-suffixed, or non-numeric value | cli-arg | - | n/a |
| 44 | `mc-name-type` | --mc-name-type <0\|1> | cli-arg | - | n/a |
| 45 | `missing-value` | any value-taking flag typed as the last argv token | cli-arg | - | n/a |
| 46 | `no-arguments-at-all` *(audit)* | launching with an empty command line | cli-arg | - | n/a |
| 47 | `no-gui` | --no-gui | cli-arg | - | n/a |
| 48 | `no-gui-without-game-dir-exits-1` *(audit)* | --no-gui with no --game-dir | cli-arg | - | n/a |
| 49 | `no-tool-command` | launching with no tool subcommand at all | cli-arg | - | n/a |
| 50 | `profile` | --profile <slug> | cli-arg | - | n/a |
| 51 | `qpro-back-composite` | --qpro-back-composite <value> | cli-arg | - | n/a |
| 52 | `qpro-back-one` | --qpro-back-one <value> | cli-arg | - | n/a |
| 53 | `qpro-body-one` | --qpro-body-one <value> | cli-arg | - | n/a |
| 54 | `qpro-clip-one` | --qpro-clip-one <value> | cli-arg | - | n/a |
| 55 | `qpro-dump` | --qpro-dump <ifs> | cli-arg | - | n/a |
| 56 | `qpro-face-one` | --qpro-face-one <value> | cli-arg | - | n/a |
| 57 | `qpro-fps` | --qpro-fps <N> | cli-arg | - | n/a |
| 58 | `qpro-hair-one` | --qpro-hair-one <value> | cli-arg | - | n/a |
| 59 | `qpro-hand-composite` | --qpro-hand-composite <value> | cli-arg | - | n/a |
| 60 | `qpro-hand-one` | --qpro-hand-one <value> | cli-arg | - | n/a |
| 61 | `qpro-head-composite` | --qpro-head-composite <value> | cli-arg | - | n/a |
| 62 | `qpro-head-one` | --qpro-head-one <value> | cli-arg | - | n/a |
| 63 | `qpro-modifier-flags-inert-alone` *(audit)* | --qpro-parts / --qpro-only / --qpro-fps / --qpro-no-hue-scope without a qpro mode flag | cli-arg | - | n/a |
| 64 | `qpro-no-hue-scope` | --qpro-no-hue-scope | cli-arg | - | n/a |
| 65 | `qpro-oneshot-precedence` *(audit)* | passing more than one qpro one-shot flag at once | cli-arg | - | n/a |
| 66 | `qpro-only` | --qpro-only <value> | cli-arg | - | n/a |
| 67 | `qpro-parts` | --qpro-parts <value> | cli-arg | - | n/a |
| 68 | `render-size` | --render-size <WxH> | cli-arg | - | n/a |
| 69 | `root-loop` | --root-loop <hold\|force> | cli-arg | - | n/a |
| 70 | `scale` | --scale <factor> | cli-arg | - | n/a |
| 71 | `screenshot-frames` | --screenshot-frames <f1,f2,...> | cli-arg | - | n/a |
| 72 | `screenshot-prefix` | --screenshot-prefix <p> | cli-arg | - | n/a |
| 73 | `seek-frame` | --seek-frame <N> | cli-arg | - | n/a |
| 74 | `show-mc-names` | --show-mc-names | cli-arg | - | n/a |
| 75 | `show-sublayer` | --show-sublayer <path> | cli-arg | - | n/a |
| 76 | `size-pair-lenient-parse` *(audit)* | --render-size / --export-size value format | cli-arg | - | n/a |
| 77 | `start-paused` | --start-paused | cli-arg | - | n/a |
| 78 | `submonitor-clip` | --submonitor-clip <path> | cli-arg | - | n/a |
| 79 | `submonitor-dwell-frames` | --submonitor-dwell-frames <N> | cli-arg | - | n/a |
| 80 | `submonitor-fade-frames` | --submonitor-fade-frames <N> | cli-arg | - | n/a |
| 81 | `submonitor-fade-in-label` | --submonitor-fade-in-label <l> | cli-arg | - | n/a |
| 82 | `submonitor-fade-out-label` | --submonitor-fade-out-label <l> | cli-arg | - | n/a |
| 83 | `submonitor-frames` | --submonitor-frames <p1,p2,...> | cli-arg | - | n/a |
| 84 | `submonitor-loop-frames` | --submonitor-loop-frames <N> | cli-arg | - | n/a |
| 85 | `submonitor-slideshow` | --submonitor-slideshow | cli-arg | - | n/a |
| 86 | `submonitor-slideshow-fade` | --submonitor-slideshow-fade | cli-arg | - | n/a |
| 87 | `submonitor-swap-layers` | --submonitor-swap-layers | cli-arg | - | n/a |
| 88 | `swap-after-frames` | --swap-after-frames <N> | cli-arg | - | n/a |
| 89 | `tool-ddr-test` | --ddr-test <in> [arc] [out.png] [frames] | cli-arg | - | n/a |
| 90 | `tool-ddr-test-arc` | --ddr-test positional 2: arc path | cli-arg | - | n/a |
| 91 | `tool-ddr-test-frames` | --ddr-test positional 4: frame count | cli-arg | - | n/a |
| 92 | `tool-ddr-test-out` | --ddr-test positional 3: output PNG path | cli-arg | - | n/a |
| 93 | `tool-extract-arc` | --extract-arc <path> | cli-arg | - | n/a |
| 94 | `tool-extract-customize` | --extract-customize <path> | cli-arg | - | n/a |
| 95 | `tool-extract-qpro-json` | --extract-qpro-json <dll> [out.json] | cli-arg | - | n/a |
| 96 | `tool-extract-qpro-json-out` | --extract-qpro-json positional 2: output JSON path | cli-arg | - | n/a |
| 97 | `tool-qpro-scan` | --qpro-scan <path> | cli-arg | - | n/a |
| 98 | `tool-scene3d-test` | --scene3d-test <in> [out.png] [frames] | cli-arg | - | n/a |
| 99 | `tool-scene3d-test-frames` | --scene3d-test positional 3: frame count | cli-arg | - | n/a |
| 100 | `tool-scene3d-test-out` | --scene3d-test positional 2: output PNG path | cli-arg | - | n/a |
| 101 | `unknown-argument` | any unrecognised token | cli-arg | - | n/a |
| 102 | `value-flag-consumes-following-flag` *(audit)* | any value-taking flag whose next argv token is itself a flag | cli-arg | - | n/a |
| 103 | `variant` | --variant <path>=<bitmap> | cli-arg | - | n/a |
