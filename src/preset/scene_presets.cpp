...
constexpr std::string_view kGameOver = "data/graph/sys/gameover";
...
constexpr std::array<SpriteLayer, 6> kMusicSelectSprites = {{
    ...
    {.package_dir = kMselect,
     ...
     .scroll_x = 1.0F,
     .scroll_wrap = 640.0F},
    {.package_dir = kMselect, .sprite = "MU_BG01", .animated = true, .priority = 29},
    {.package_dir = kMselect,
     .sprite = "DIFF_BAR",
     .ui = true,
     .x = 143.0F,
...
constexpr GcAnim::Timing kCardPrompt = {
    .playback = GcAnim::Playback::HoldLast, .loop_start = 80, .loop_end = 200};
constexpr GcAnim::Timing kStartPrompt = {
    .playback = GcAnim::Playback::Loop, .loop_start = 40, .loop_end = 156};
...
constexpr std::array<SpriteLayer, 7> kCardInSprites = {{
...
constexpr std::array<SpriteLayer, 1> kLoginSprites = {{
    {.package_dir = kTitle, .sprite = "LOGIN", .animated = true, .priority = 15, .timing = kOnce},
}};
...
constexpr std::array<SpriteLayer, 3> kModeSelectSprites = {{
    {.package_dir = kMode,
     .sprite = "MODE_BG_LOOP",
     .animated = true,
     .priority = 25,
     .timing = kLoop,
     .ui_parts = kModeSelectChrome},
    {.package_dir = kMode,
     .sprite = "MODE_NAME",
     .animated = true,
     .ui = true,
...
constexpr std::array<SpriteLayer, 2> kDanSelectSprites = {{
...
constexpr std::array<SpriteLayer, 3> kNewPlayerSprites = {{
    {.package_dir = kCard, .sprite = "CARD_BG", .animated = true, .priority = 31, .timing = kHold},
    {.package_dir = kCard,
     .sprite = "PLAYER1",
     .animated = true,
...
constexpr std::array<SpriteLayer, 1> kGameOverSprites = {{
    {.package_dir = kGameOver,
     .sprite = "GAMEOVER",
     .animated = true,
     .priority = 10,
     .timing = kOnce},
