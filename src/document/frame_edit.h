...
[[nodiscard]] Support::Expected<void, std::string> AddDepth(AfpAnimation::Animation& animation,
                                                            uint16_t depth, uint16_t character,
                                                            uint32_t first_frame,
                                                            uint32_t last_frame);

[[nodiscard]] Support::Expected<void, std::string> RemoveDepth(AfpAnimation::Animation& animation,
